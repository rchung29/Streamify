...
const SongDetails = () => {
    ...
    return (
        <div className='flex flex-col'>
            ...
            <div className='mb-10'>
                <h2 className='text-zinc-100 text-3xl font-semibold'>Lyrics:</h2>
                <div className='mt-5'>
                    {songData?.sections[1].type === 'LYRICS' ?
                        songData?.sections[1].text.map((line, i) => (
                            <p className='text-zinc-600 text-base my-1'>{line}</p>
                        )) : <p className='text-zinc-600 text-base my-1'>Sorry, no lyrics found!</p>}
                </div>
            </div>
